...
const config: Config = {
  title: 'ITS - EduVision',
  tagline: 'Intelligent Tutoring System',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Cyborg/EduVision', 
          label: 'GitHub',
          position: 'right',
        },
        {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} EduVision ITS. Built with Docusaurus.`,
    },
    prism: {
